...
class SampleFragment: YsBaseFragment<SampleViewModel, FragmentSampleBinding>() {
    override fun initViewModel() {
        viewModel = ViewModelProviders.of(requireActivity(), BaseModelFactory(requireActivity()))[SampleViewModel::class.java]
    }
